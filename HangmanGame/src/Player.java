...
public class Player extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            // Create connection to server (TCP socket used)
            connectToServer();
    ...
    public static void connectToServer() {
        try {
            // Connect to the server (TCP socket used)
    ...
    private static void isQuit(String s) {
        // If a player quit the game while it's running
        if (s.contains("quit")) {
